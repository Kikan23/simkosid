                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('jadwal_kerja') is-invalid @enderror" 
                                            id="jadwal_kerja" 
                                            name="jadwal_kerja" 
                                            required>
                                        <option value="">Pilih Jadwal Kerja</option>
                                        <option value="Senin - Kamis" {{ old('jadwal_kerja') == 'Senin - Kamis' ? 'selected' : '' }}>
                                            Senin - Kamis
                                        </option>
                                        <option value="Jum'at - Minggu" {{ old('jadwal_kerja') == 'Jum\'at - Minggu' ? 'selected' : '' }}>
                                            Jum'at - Minggu
                                        </option>
                                    </select>
                                    @error('jadwal_kerja')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_pegawai') is-invalid @enderror" 
                                        ...
                                        <option value="tidak_aktif" {{ old('status_pegawai') == 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
